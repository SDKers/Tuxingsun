...
//            L.v("没有开启的辅助功能应用");
    ...
    /**
     * pm grant com.helper android.permission.WRITE_SECURE_SETTINGS
     * settings put secure enabled_accessibility_services com.helper/com.auto.assess.MyAccessibilityService
     * settings put secure accessibility_enabled 1
     * @param context
     * @param clazz
     */
    public static void openAccessibilityService(Context context, Class<? extends AccessibilityService> clazz) {
        if (context == null) {
            return;
        }
        ...
        ShellHelper.more(
                "pm grant " + pkgName + " android.permission.WRITE_SECURE_SETTINGS"
                , "settings put secure enabled_accessibility_services " + pkgName + "/" + className
                , "settings put secure accessibility_enabled 1"
        );
    }
